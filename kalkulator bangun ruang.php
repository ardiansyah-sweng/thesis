...
interface menghitung_bangun_ruang
{
    public function hitung();
}

class LuasPersegiPanjang implements menghitung_bangun_ruang
{
    public $Panjang = 0;
    public $Lebar = 0;
...
class VolumeBola implements menghitung_bangun_ruang
{
    public $jariJari = 0;
...
class VolumeKerucut implements menghitung_bangun_ruang
{
...
class VolumeKubus implements menghitung_bangun_ruang
{
    public $Rusuk = 12;
...
class KelilingLingkaran implements menghitung_bangun_ruang
{
    Public $DUA = 2;
    public $jariJari = 14;
    public $PHI = 3.14;
