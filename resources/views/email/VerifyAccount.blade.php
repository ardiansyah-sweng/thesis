                            ...
                            <div style="color:#132F40;padding:10px 10px 10px 10px;">
                                <div style="font-size: 12px; mso-line-height-alt: 14px;">
                                    <p style="font-size: 22px; word-break: break-word; mso-line-height-alt: 26px; margin: 0;">
                                        <!-- SAPAAN PENERIMA -->
                                        <span style="font-size: 22px;">Halo <strong ST>{{$mailData['nama']}}</strong>,</span>
                                        <!-- BATAS SAPAAN -->
                                    </p>
                                </div>
                            </div>
                            <div style="color:#555555;line-height:1.5;padding-top:5px;padding-right:10px;padding-bottom:30px;padding-left:10px;">
                                <div style="font-size: 12px; line-height: 1.5; mso-line-height-alt: 18px;">
                                    <p style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">{{$mailData['isiEmail']}}</p>
                                </div>
                            </div>
                            <div style="padding-top :30px;padding-bottom:20px;">
                                <div style=" position: absolute;top: 50%;left: 50%;-ms-transform: translate(-50%, -50%);transform: translate(-50%, -50%);">
                                    <!-- Button -->
                                    <a href="{{$mailData['url']}}" class="button" style="background-color: #fff;color: #17bebb;border-bottom: 1px solid #17bebb;border-left: 1px solid #17bebb;border-right: 1px solid #17bebb;border-top: 1px solid #17bebb; -webkit-text-size-adjust: none;border-radius:10px; display: inline-block; overflow: hidden; text-decoration: none;text-align: center;box-shadow: 0px 0px 10px #d3d3d3;padding: 10px 20px;cursor: pointer; margin:auto;">
                                        AKTIFASI SEKARANG
                                    </a>
                                    <!-- Batas Button -->
                                </div>
                            </div>
                            <div style="color:#555555;padding-top:30px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                <div style="font-size: 12px; mso-line-height-alt: 14px;">
